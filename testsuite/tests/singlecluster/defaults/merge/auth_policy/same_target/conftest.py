...
def authorization(cluster, blame, user_label, route, user_api_key):
    ...
    auth_policy.defaults.identity.add_api_key("basic", selector=user_api_key.selector)
    return auth_policy


@pytest.fixture(scope="module")
def default_merge_authorization(cluster, blame, admin_label, route, admin_api_key):
    """
    ...
    """
    auth_policy = AuthPolicy.create_instance(cluster, blame("dmp"), route, labels={"testRun": admin_label})

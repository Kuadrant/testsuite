...
from testsuite.tests.singlecluster.gateway.test_scale_listeners import gateway
...
@pytest.mark.parametrize("authorization, global_authorization", [("gateway", "gateway"), ("route", "route")], indirect=True, ids=["gateway", "route"])

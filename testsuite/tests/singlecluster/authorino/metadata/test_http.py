...
def authorization(authorization, country_mock_expectation, module_label):
    ...
    """
    authorization.rules.metadata.add_http("mock", country_mock_expectation, "GET")
    authorization.rules.authorization.add_opa_policy("opa_" + module_label, CHECK_COUNTRY_REGO)

...
def dns_record(cluster, gateway, hostname, dns_provider_secret, blame, module_label):
    ...
    record = DNSRecord.create_instance(
        ...
        endpoints=[DNSRecordEndpoint(dnsName=hostname.hostname, recordType="A", recordTTL=300, targets=[gateway_ip])],
        delegate=False,

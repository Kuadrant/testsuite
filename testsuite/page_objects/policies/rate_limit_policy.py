...
class RateLimitNewPage(Navigable):
    ...
    def create_yaml(self, rate_limit_policy: RateLimitPolicy):
        ...
        self.page.wait_for_selector("text=RateLimitPolicy has been successfully enforced", timeout=60000)
    ...
    def page_displayed(self):
        """Check if the RateLimitPolicy creation page is displayed"""
